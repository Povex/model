...
class ExperimentsByRandomPos:
    ...
    def __init__(self, metrics: List[str], n_simulations=4, base_path=Path('results/random_pos_results')):
        super().__init__()
...
def main():
    ...
    random_pos_experiments = ExperimentsByRandomPos(metrics)
    random_pos_experiments.run_random_pos_experiments()
